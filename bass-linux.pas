...
function BASS_ErrorGetCode: Integer; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
...
function BASS_Init(device: Integer; freq, flags: DWORD; win: HWND; clsid: PGUID): BOOL; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
...
function BASS_PluginLoad(filename: PAnsiChar; flags: DWORD): HPLUGIN; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
...
{$IFDEF WIN32}
function BASS_SetEAXParameters(env: Integer; vol, decay, damp: FLOAT): BOOL; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
...
function BASS_RecordInit(device: Integer):BOOL; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
...
function BASS_RecordGetInputName(input: Integer): PAnsiChar; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
function BASS_RecordSetInput(input: Integer; flags: DWORD; volume: FLOAT): BOOL; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
function BASS_RecordGetInput(input: Integer; var volume: FLOAT): DWORD; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
...
function BASS_ChannelSet3DAttributes(handle: DWORD; mode: Integer; min, max: FLOAT; iangle, oangle, outvol: Integer): BOOL; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
...
function BASS_ChannelSetDSP(handle: DWORD; proc: DSPPROC; user: Pointer; priority: Integer): HDSP; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
...
function BASS_ChannelSetFX(handle, type_: DWORD; priority: Integer): HFX; {$IFDEF WIN32}stdcall{$ELSE}cdecl{$ENDIF}; external bassdll;
